...
class PhotoViewSet(viewsets.ModelViewSet):
    queryset = Photo.objects.public().select_related('creator', 'source', 'license').prefetch_related('tags')
...
class VideoViewSet(viewsets.ModelViewSet):
    queryset = Video.objects.public().select_related('creator', 'source', 'license').prefetch_related('tags')
    filter_backends = (filters.DjangoFilterBackend, OrderingFilter, SearchFilter)
...
class YouTubeVideoViewSet(viewsets.ModelViewSet):
    queryset = YouTubeVideo.objects.public().select_related('creator', 'license').prefetch_related('tags')
